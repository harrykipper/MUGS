...
One going approach in evaluating the meaning of our findigs is that we should use the model to give us a _broad_ sense of something that _may_ be going on, in some form, in the real world. Or affecting other mechanisms and behaviour taking place in the world outside the computer. Provide insight into the phenomenon, offer a different, less explored angle. What this model tells us is that the simple rule of behaviour that we postulate, loosely drawing on diverse evidence, is **sufficient** to generate the phenomenon at hand. This holds if we have a somewhat _restrictive_ definition of "the phenomenon". If we circumscribe it to the socioeconomic gradient + Edinburgh effect, that is. If we were to consider "the phenomenon" to also include, say, the exact sorting of cities with regards to average visits to green spaces, then the hypothesis tested would stop being sufficient for the phenomenon to emerge.

However, in the context of a Public Health outlook on the topic, in spite of its somewhat diminutive underlying behavioural assumptions, this model does provide some insight into the issues suggests that at the basis of the currently observed inequalities in green space usage might be issues broader than currently acknowledged. Issues related to social integration, both in the sense of _spatial_ integration and perception and acceptance of others.
